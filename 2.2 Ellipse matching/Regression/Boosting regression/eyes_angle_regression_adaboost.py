...
an Adaboost model on the angle parameters of the ellipses contained in said images. It then saves the model
...
clf = AdaBoostRegressor(random_state=0, n_estimators=n_estimator, learning_rate = 1)
...
print("\n  REPORT OF ERRORS FOR adaboost regressor ", n_estimator, " estimators")
