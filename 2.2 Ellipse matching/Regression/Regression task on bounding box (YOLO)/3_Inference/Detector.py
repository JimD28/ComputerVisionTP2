...
# image_test_folder = os.path.join(image_folder,'Training_Images')

detection_results_folder = os.path.join(image_folder, 'Test_Image_Detection_Results')
# detection_results_folder = os.path.join(image_folder,'Result_add_test')
detection_results_file = os.path.join(detection_results_folder, 'Detection_Results.csv')

# Number of ellipse per image (New line from computer vision project)
n_ellipses_path = os.path.join(detection_results_folder, "Detection_Results_n_ellipses.csv")
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        # For the computer vision project we removed the postfix
        '--postfix', type=str, dest='postfix', default='',
    ...
    if input_image_paths:
        ...
        # This is for images
        # (New line from computer vision project)
        with open(n_ellipses_path, 'a') as n_ellipses_file:
            n_ellipses_file.write("image_path, n_ellipses\n")
