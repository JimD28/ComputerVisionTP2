...
if __name__ == '__main__':
    ...
    # Requires python in environment path on Windows AND to go to "Gérer les alias d'exécution d'application" and turn
    # off "Programme d'installation d'application" for python and python3
